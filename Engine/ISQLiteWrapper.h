...
public:
    ...
    virtual std::tuple<int, Phase, std::string> GetRule(const HandCharacteristic& handCharacteristic, std::vector<bool>& fits, const Phase& phase, int lastBidId, int position) = 0;
