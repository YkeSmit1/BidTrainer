...
public:
    ...
    virtual std::string GetRulesByBid(int bidId, int position, const std::string& previousBidding, bool isCompetitive) = 0;
    virtual std::vector<std::unordered_map<std::string, std::string>> GetInternalRulesByBid(int bidId, int position, const std::string& previousBidding, bool isCompetitive) = 0;
